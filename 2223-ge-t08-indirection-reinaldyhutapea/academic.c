...
printf("%s|%s|%s|%s%.2f\n", _enrollment.course.code, _enrollment.student.id, grade_to_text(_enrollment.grade), _enrollment.year[0] == GRADE_NONE ? "None" : "", calculate_performance(_enrollment.grade, _enrollment.course.credit));
}
